layui.use(['form', 'jquery', 'laydate', 'element', 'laypage', 'laytpl'], function(){
    ...
    function loadTable (data) {
        ...
        $.ajax({
            url: '../../module/merchandise_control/merchandise_warehouse.html',
            type: 'get',
            data: '',
    ...
    // 删除商品
    $(".merchandise_warehouse_table").on("click", ".delete_btn", function () {
          var tr = $(this).parents("tr");
          var goodId = tr.data('id');
   ...
   $(".merchandise_warehouse_table").on('click', '.detail_btn', function () {

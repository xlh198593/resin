 ...
 */
@Component
public class DeductionSkuServiceHandler extends BaseServiceHandler {
    ...
    public ServiceName getServiceName() {
        return ServiceName.DEDUCTION_SKU_STOCK;
    }
    ...
    public void handle(Map<String, Object> paramsMap, ResultData result) throws BusinessException {
        ...
        BkcqProducts bkcqProducts = bkcqProductsService.deductionSkuStock(freezeSkuStockDTO);

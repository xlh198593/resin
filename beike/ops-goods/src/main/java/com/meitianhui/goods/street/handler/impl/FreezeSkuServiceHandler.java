 ...
 */
@Component
public class FreezeSkuServiceHandler extends BaseServiceHandler {
    ...
    public ServiceName getServiceName() {
        return ServiceName.FREEZE_SKU_STOCK;
    }
    ...
    public void handle(Map<String, Object> paramsMap, ResultData result) throws BusinessException {
        ...
        BkcqProducts bkcqProducts = bkcqProductsService.freezeSkuStock(freezeSkuStockDTO);

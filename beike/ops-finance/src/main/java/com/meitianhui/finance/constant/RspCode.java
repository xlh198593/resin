...
public class RspCode extends CommonRspCode {
     ...
     * 交易状态不正确
     **/
    public static String TRADE_STATUS_INCORRECT = "trade_status_incorrect";
    /**
     * 没有利润
     **/
    public static String NOT_PROFIT = "not_profit";
    /**
     * 没有资产信息
     */
    public static String NOT_ASSET_INFORMATION = "not_asset_information";
    /**
     * 亲情卡已被使用
     **/
     ...
     * 微信统一下单异常
     **/
    public static String WECHAT_UNIFIEDORER_ERROR = "wechat_unifiedorder_error";
    /**
     * 支付宝支付异常
     **/
     ...
     * 订单金额错误
     **/
    public static String ORDER_AMOUNT_ERROR = "order_amount_error";
    /**
     * 贝壳金额错误
     **/
    public static String SHELL_AMOUNT_ERROR = "shell_amount_error";
    /**
     * 优惠券不存在
     **/
    ...
    public static String TELEPHONE_CHARGE_ERROR = "telephone_charge_error";

    /**非新用户无法领取68贝壳*/
	public static String NOT_NEW_USER = "not_new_user";

	/**
	 * 已领取 请勿重复领取
	 */
	public static String USER_RECEIVED = "USER_RECEIVED";
    ...
    static {
        ...
        MSG.put(ORDER_AMOUNT_ERROR, "订单金额错误");
        MSG.put(SHELL_AMOUNT_ERROR, "贝壳数量错误");
        MSG.put(TELEPHONE_CHARGE_ERROR, "一个月只能充一次");
        MSG.put(TRADE_STATUS_INCORRECT, "交易状态不正确");
        MSG.put(NOT_PROFIT, "没有利润");
        MSG.put(NOT_ASSET_INFORMATION, "没有资产信息");
	    MSG.put(NOT_NEW_USER, "抱歉您非新用户,无法领取哦!");
		MSG.put(USER_RECEIVED, "您已领取该福利,请勿重复领取");
    }
}

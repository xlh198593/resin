...
public class FgOrder implements Serializable {
	...
	/** 佣金**/
	private BigDecimal order_commision;
	/** 新旧商品区分标识,1是新自营 **/
	...
	public BigDecimal getOrder_commision() {
		return order_commision;
	}
	public void setOrder_commision(BigDecimal order_commision) {
		this.order_commision = order_commision;
	}

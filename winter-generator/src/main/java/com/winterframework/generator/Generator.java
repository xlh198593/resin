...
import com.winterframework.generator.util.FileHelper;
...
public class Generator {
	...
	private List<Exception> generateBy(File templateRootDir, Map templateModel, Map filePathModel) throws Exception {
		...
		for (int i = 0; i < templateFiles.size(); i++) {
			...
			try {
				System.out.println("[wwy] outputFilePath:"+outputFilePath);
...
//		Set set  = templateModel.keySet();
//		Iterator it = set.iterator();
//		while(it.hasNext()){
//			String s = (String)it.next();
//			System.out.println("[wwy] templateModel value:"+templateModel.get(s));
//		}
		System.out.println("[wwy] targetFilename :"+targetFilename);
		System.out.println("[wwy] templateFile:"+templateFile);
		System.out.println("[wwy] outputFilePath:"+outputFilePath);
		...
		System.out.println("[wwy]" + absoluteOutputFilePath.getAbsolutePath()+absoluteOutputFilePath.getName());
